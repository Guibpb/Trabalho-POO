...
public class MusicDatabase {
    public static List<String[]> getMusicCSVFile(){
        ...
        File musicCSVFile = new File("Database/musics.csv");
        try {
            ...
            BufferedReader reader = new BufferedReader(new FileReader("Database/musics.csv"));
    ...
    public static void updateMusicCSVFile(List<String[]> musicCSVFileList){
        ...
        try {
            ...
            PrintWriter writer = new PrintWriter(new FileWriter("Database/musics.csv"));
