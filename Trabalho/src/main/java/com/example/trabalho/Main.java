...
public class Main extends Application {
    ...
    public void start(Stage stage) throws IOException {
        FXMLLoader fxmlLoaderLogin = new FXMLLoader(Main.class.getResource("telaLogin.fxml"));
        ...
        FXMLLoader fxmlLoaderRegistro = new FXMLLoader(Main.class.getResource("telaRegistro.fxml"));
